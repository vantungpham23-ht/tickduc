				...
				{#if currentData.icon === 'lotus'}
					<div class="w-28 h-28 mx-auto animate-gentle-glow">
						<svg class="w-full h-full text-[#C5A059]/60" viewBox="0 0 80 80" fill="none">
							...
							<ellipse cx="40" cy="22" rx="8" ry="16" fill="currentColor" opacity="0.5" transform="rotate(180 40 48)"/>
							<ellipse cx="40" cy="22" rx="8" ry="16" fill="currentColor" opacity="0.5" transform="rotate(240 40 48)"/>
							<ellipse cx="40" cy="22" rx="8" ry="16" fill="currentColor" opacity="0.5" transform="rotate(300 40 48)"/>
							<circle cx="40" cy="48" r="6" fill="currentColor" opacity="0.6"/>
						</svg>
					</div>
				{:else if currentData.icon === 'lotus-seated'}
					<div class="w-28 h-28 mx-auto">
						<svg class="w-full h-full text-[#93B1A7]/60" viewBox="0 0 80 80" fill="none">
							...
							<path d="M32 42 L40 35 L48 42" stroke="currentColor" stroke-width="2" fill="none" opacity="0.4"/>
						</svg>
					</div>
				{:else if currentData.icon === 'mokugyo'}
					<div class="w-28 h-28 mx-auto">
						<svg class="w-full h-full text-[#C5A059]/60" viewBox="0 0 80 80" fill="none">
							...
							<path d="M40 40 L40 28" stroke="currentColor" stroke-width="3" opacity="0.5"/>
							<ellipse cx="40" cy="26" rx="6" ry="4" fill="currentColor" opacity="0.4"/>
						</svg>
					</div>
				{:else}
					<div class="w-28 h-28 mx-auto">
