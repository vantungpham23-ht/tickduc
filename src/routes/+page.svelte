...
<div class="min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
	...
	<div class="fixed inset-0 overflow-hidden pointer-events-none">
		<div class="absolute top-1/4 left-1/4 w-80 h-80 bg-[#C5A059]/8 rounded-full blur-3xl animate-float-drift"></div>
		<div class="absolute bottom-1/3 right-1/4 w-64 h-64 bg-[#93B1A7]/10 rounded-full blur-3xl animate-float-drift" style="animation-delay: -3s;"></div>
		<div class="absolute top-1/2 right-0 w-48 h-48 bg-[#C5A059]/5 rounded-full blur-3xl animate-float-drift" style="animation-delay: -6s;"></div>
	</div>
	...
	<div class="relative z-10 text-center">
		...
		<div class="opacity-0 animate-fade-in-up" style="animation-delay: 0.3s; animation-fill-mode: forwards;">
			<h1 class="font-serif text-3xl font-light text-[#4A3F35] tracking-widest mb-3">
				Tích Công Đức
			</h1>
			<div class="flex items-center justify-center gap-3 mb-1">
				<div class="w-8 h-px bg-gradient-to-r from-transparent to-[#C5A059]/40"></div>
				<p class="text-[#9A8E80] text-sm font-light tracking-wider">Nuôi dưỡng tâm hồn an lạc</p>
	...
	<div class="absolute bottom-24 left-1/2 -translate-x-1/2 w-36 opacity-0 animate-fade-in" style="animation-delay: 0.5s; animation-fill-mode: forwards;">
		<div class="h-[1px] bg-[#C5A059]/20 rounded-full overflow-hidden">
			<div class="h-full bg-gradient-to-r from-[#C5A059]/50 to-[#D4B896]/70 rounded-full transition-all duration-100" style="width: {progress}%;"></div>
		</div>
	</div>
	...
	<div class="absolute bottom-12 left-6 right-6 text-center opacity-0 animate-fade-in" style="animation-delay: 0.8s; animation-fill-mode: forwards;">
		<p class="text-[#9A8E80]/40 text-xs italic font-serif-alt tracking-wide">
